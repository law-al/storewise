  ...
  return (
    <>
      <SheetHeader className="py-2">
        <SheetTitle className="flex items-center justify-between pb-3 mb-4 border-b border-gray-200">
          ...
          <div className="mb-3">
            ...
            <div className="flex flex-wrap items-center gap-2">
              {searchOptions.map((item) => (
                <button
                  key={item.title}
                  className="flex items-center gap-2 p-2 text-black border border-gray-700 rounded-full hover:bg-gray-100"
                >
                  <item.logo size={16} />
            ...
            <div className="">
              {searchOrderSummary.map((item) => (
                <div
                  ...
                  className="flex items-center gap-2 p-2 rounded-md cursor-pointer hover:bg-gray-300/20"
                >
                  <ShoppingBag />
                  <div className="">
